...
/**
 * Release line <code>8.9</code>, the current GA line, which is also what a build without a profile produces.
 * <p>
...
public class Camunda8ReleaseLineTest {
  ...
  @Test
  @DisplayName("the build belongs to line 8.9 and knows the client it pinned")
  public void theLineIsTheOneTheProfileSelected() {

    assertEquals("8.9", Camunda8ReleaseLine.id());

    assertTrue(
        Camunda8ReleaseLine.clientVersion().startsWith("8.9."),
        "line 8.9 has to be built against a Camunda client 8.9.x, but the descriptor says '"
