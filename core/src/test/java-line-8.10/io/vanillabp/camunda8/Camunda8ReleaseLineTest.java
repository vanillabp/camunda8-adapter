...
public class Camunda8ReleaseLineTest {
  ...
  @Test
  @DisplayName("the build belongs to line 8.10 and knows the client it pinned")
  public void theLineIsTheOneTheProfileSelected() {

    assertEquals("8.10", Camunda8ReleaseLine.id());

    assertTrue(
        Camunda8ReleaseLine.clientVersion().startsWith("8.10."),
        "line 8.10 has to be built against a Camunda client 8.10.x, but the descriptor says '"
