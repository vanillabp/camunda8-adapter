...
/**
 * Hands the client the executor of the virtual-thread mode. This is the 8.10 variant.
 * <p>
 ...
 * something says otherwise. {@link Camunda8VirtualThreadExecutor} serves both roles, so
 * it is installed twice: as the scheduling executor, which the client owns and shuts
 * down, and as the job-handling executor, which it must not shut down a second time.
 */
