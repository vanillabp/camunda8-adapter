# Working on camunda8-adapter

The VanillaBP adapter for a remote Camunda 8 cluster, on Spring Boot and on Quarkus, released once
per Camunda minor from one source tree.

Read [`README.md`](./README.md) first: it says which release line you are building, what needs
