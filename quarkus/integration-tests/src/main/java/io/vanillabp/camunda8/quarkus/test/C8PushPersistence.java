...
/**
 * JPA persistence of {@link C8PushAggregate} - saves within the caller's JTA transaction, which
 * is the transaction a task handler runs in.
 */
@ApplicationScoped
public class C8PushPersistence implements AggregatePersistenceAware<C8PushAggregate> {

  @Inject
  EntityManager entityManager;

  @Override
  public Class<C8PushAggregate> getAggregateClass() {

    return C8PushAggregate.class;

  }

  @Override
  public C8PushAggregate save(
  ...
  @Override
  public C8PushAggregate loadById(
      final Object aggregateId) {

    return entityManager.find(C8PushAggregate.class, aggregateId);
